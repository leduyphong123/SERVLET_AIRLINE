...
<!-- Navbar -->
<form action="/booking?action=view&idFlight=${element.getFlighId()}&idUser=" method="post">
    <div class="container mt-5 py-5">
        <div class="row justify-content-center p-5 bg-body shadow rounded border-info border">
            ...
            <div class=" flex-row-reverse d-flex mt-4 col-10">
