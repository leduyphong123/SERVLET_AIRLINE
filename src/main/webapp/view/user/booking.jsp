...
<div class="container mt-5 py-5">
    <div class="row justify-content-center p-5 bg-body shadow rounded border-info border">
        <div class="col-10 ">
            <form action="/booking?action=create&idFlight=${element.getFlighId()}&idApc=${airplanChairId}&idUser=${idUser}" method="post">
                ...
                <div class="button-submit text-center mt-3">
                    <button type="submit" class="btn btn-primary btn-rounded mt-3 ">Buy</button>
                </div>
            </form>
        </div>

        <h4 class="my-5 text-center">Flight deteils</h4>
        ...
        <div class="col-10 p-4 rounded shadow mb-5 wrap-hover-color" id="wrapNewHidden-1">
            <div class="d-flex justify-content-between ">
                ...
                <div class="col-2"><span class="text-danger">${element.getAirplaneChairPrice()}</span> vnd/guest
                </div>
            </div>
