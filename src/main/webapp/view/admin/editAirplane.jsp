  ...
  <div class="container pt-4 ">
    <div class="row justify-content-center">
      ...
      <div class="col-12 my-4">
        <a class="btn btn-success" href="/airplane?page=1" role="button">List airline</a>

      </div>
      <div class="col-12 py-5 bg-body shadow-sm">
        <h3 class="my-3 text-center">Edit Airplane</h3>

        <div class="row justify-content-center">


          <div class="col-8">
            <form action="/airplane?aution=edit&id=${element.getId()}" method="post">
              ...
              <div class="form-outline mt-3">
                <input type="text" id="capacity" name="capacity" class="form-control" value="${element.getCapacity()}"/>
