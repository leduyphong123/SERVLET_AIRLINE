  ...
  <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-white">
    <div class="position-sticky">
      <div class="list-group list-group-flush mx-3 mt-4">
        ...
        <a href="/chair?page=1" class="list-group-item list-group-item-action py-2 ripple active"><i
  ...
  <div class="container pt-4 ">
    <div class="row justify-content-center">
      ...
      <div class="col-12 my-4">
        <a class="btn btn-success" href="/chair?aution=create" role="button">New chair</a>
      </div>
...
<script>
  function alertActive(id,state){
    if (window.confirm('You Not Active Chair'))
    {
