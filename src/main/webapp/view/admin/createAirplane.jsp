    ...
    <div class="container pt-4 ">
        <div class="row justify-content-center">
            ...
            <div class="col-12 my-4">
                <a class="btn btn-success" href="/airplane?page=1" role="button">List airplane</a>

            </div>
            <div class="col-12 py-5 bg-body shadow-sm">
                <h3 class="my-3 text-center">New Airplane</h3>

                <div class="row justify-content-center">
                    <div class="col-8">
                        <form action="/airplane?aution=create" method="post">
                            ...
                            <div class="form-outline mt-3">
                                ...
                                <label class="form-label" for="capacity">Storage capacity</label>
                            </div>
                            <select class="form-select mt-3" aria-label="Default select example" name="alId">
