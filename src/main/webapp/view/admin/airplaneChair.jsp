  ...
  <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-white">
    <div class="position-sticky">
      <div class="list-group list-group-flush mx-3 mt-4">
        ...
        <a href="/airplaneChair?page=1" class="list-group-item list-group-item-action py-2 ripple active" ><i
  ...
  <div class="container pt-4 ">
    <div class="row justify-content-center">
      ...
      <div class="col-12 my-4">
        <a class="btn btn-success" href="/airplaneChair?aution=create" role="button">New Airplane chair</a>
      </div>
          ...
          <c:when test="${elementList.size()!=0}">
            <table class="table table-bordered border-primary ">
              ...
              <tr>
                ...
                <th class="col-3" scope="col">Name Airplane</th>
                <th class="col-2" scope="col">Name Chair</th>
              ...
              <c:forEach items="${elementList}" var="element">
                <tr>
                  <td scope="row"><%=i+=1%></td>
                  <td>${element.getApName()}</td>
                  <td>${element.getcName()}</td>
                  <td>${element.getPrice()}</td>
                  <td>${element.getPlayDate()}</td>
                  <td class="d-flex justify-content-center">
                    <a class="btn btn-info action-btn" href="/airplaneChair?aution=view&id=${element.getId()}" role="button">View</a>
                    <a class="btn btn-primary action-btn" href="/airplaneChair?aution=edit&id=${element.getId()}" role="button">Edit</a>
                    <c:choose>
                      <c:when test="${element.isState()==true}">
                        <a class="btn btn-success" href="/airplaneChair" onclick="alertActive(${element.getId()},${element.isState()})" role="button">in active</a>
                      </c:when>
                      <c:otherwise>
                        <a class="btn btn-danger wrapper-active-btn" href="/airplaneChair" onclick="alertActive(${element.getId()},${element.isState()})" role="button">active</a>
                      </c:otherwise>
                    </c:choose>
                  </td>
                </tr>
